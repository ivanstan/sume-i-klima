 ...
 */
final class Version20190318210448 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_course_node_instance (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, node_id INT NOT NULL, instance_id INT NOT NULL, date DATETIME NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_81313E2DA76ED395 (user_id), UNIQUE INDEX UNIQ_81313E2D460D9FD7 (node_id), INDEX IDX_81313E2D3A51721D (instance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE course_node (id INT AUTO_INCREMENT NOT NULL, course_id INT NOT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, weight INT DEFAULT NULL, available_after VARCHAR(255) DEFAULT NULL COMMENT \'(DC2Type:dateinterval)\', type VARCHAR(255) NOT NULL, INDEX IDX_4DDD3543591CC992 (course_id), INDEX IDX_4DDD3543727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course_node_assigment (id INT NOT NULL, file_id INT NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_9992120D93CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE course_node_lesson (id INT NOT NULL, url VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_course_node_quiz (id INT NOT NULL, result_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9C0275757A7B643 (result_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_course_node_quiz ADD CONSTRAINT FK_9C0275757A7B643 FOREIGN KEY (result_id) REFERENCES quiz_question_result (id)');
