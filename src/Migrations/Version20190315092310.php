 ...
 */
final class Version20190315092310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quiz_result ADD CONSTRAINT FK_FE2E314AAA334807 FOREIGN KEY (answer_id) REFERENCES quiz_answer (id)');
